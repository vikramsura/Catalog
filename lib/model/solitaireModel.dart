class SolitaireModel {
  ...
  int? status;
  String? message;
  List<SolitaireModelData>? data;

  SolitaireModel({this.success, this.status, this.message, this.data});

  SolitaireModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <SolitaireModelData>[];
      json['data'].forEach((v) {
        data!.add(SolitaireModelData.fromJson(v));
      });
    }
  }
...
class SolitaireModelData {
  ...
  SolitaireModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
